...
public class sc_camera_bounds : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        limitsMin = cam.ScreenToWorldPoint(new Vector3(Screen.width, Screen.height, tr.position.z));
    ...
    void LateUpdate()
    {
        ...
        viewPos.y = Mathf.Clamp(viewPos.y, limitsMin.y + spriteSize.y, limitsMax.y -spriteSize.y);
        tr.position = viewPos;
    }
}
