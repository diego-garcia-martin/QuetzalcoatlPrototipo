...
public class sc_spacePichoncin : MonoBehaviour
{
    ...
    private const string IDLE = "Anim_SpacePichoncin_idle";
    private const string FLY = "Anim_SpacePichoncin_vuelo";
    private const string EAT = "Anim_SpacePichoncin_picando";
